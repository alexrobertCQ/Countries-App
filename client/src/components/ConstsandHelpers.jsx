...
export const seasons = ["Summer", "Spring", "Winter", "Fall"];
export const duration = ["1 hour", "2 hours", "3 hours", "4 hours", "5 hours", "6 hours", "Fullday"];
export const continents = ["All", "Africa","Antarctica","Asia","Europe","North America","Oceania","South America"];
export const reg_ex = (/^[A-Za-z]+$/);

export const imgNotFoundurl = //de flaticon se saca los iconos
"https://images.pexels.com/photos/7412069/pexels-photo-7412069.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1";
...
export const sqrmetters="https://cdn-icons-png.flaticon.com/512/5194/5194031.png";
export const location="https://cdn-icons-png.flaticon.com/512/584/584517.png";
export const imgcontinents="https://cdn-icons-png.flaticon.com/512/869/869198.png";