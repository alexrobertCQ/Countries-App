...
const Activities = () => {
    ...
    return(
        <div>
            <h1 className={Style.mainContainer}>Tours around the world</h1>
            <div className={Style.Container}>
                    {activities.map(activitie =>(
                        ...
                        <button className={Style.myButton} onClick={(event) => handlerDelete(event,activitie.name)}>Delete</button>
                        </div>
                    ))}
            </div>
        </div>
