...
const CreateTour = () => {
    ...
    const validate=(state)=>{
        ...
        if(!state.name) errors.name="Nombre de actividad requerido";
        else if(name_repeated.length) errors.name=`La actividad →${state.name}← ya fue creada`;
    ...
    const handlerSubmit = (event) => {
        ...
        alert(`La actividad ${state.name} ha sido creado con éxito`);
    } 
        ...
        <div className={Style.main}>
            ...
            <form className={Style.form} onSubmit={handlerSubmit}>
                <div className={Style.containerA}>
                    <label className={Style.labelB}>Name: </label>
                        <input  type="text" 
                                name="name"
                    ...
                    <label className={Style.labelB}>Difficulty: </label>
                    ...
                    <label className={Style.labelB}>Duration: </label>
                        <div className={Style.select}>
                            <select className={Style.dropdown} 
                                    name="duration" 
                                    onChange={handlerChange} 
                    ...
                    <label className={Style.labelB}>Season: </label>
                        <div className={Style.select}>
                            <select className={Style.dropdown} 
                                    name="season" 
                                    onChange={handlerChange} 
